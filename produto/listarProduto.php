        ...
        <tr>
            ...
            <td>
                <div class="btn-group btn-group-sm" role="group" aria-label="Basic outlined example">
                    ...
                    <button type="button" onclick="ativarGeral(<?php echo $id ?>, 'ativar', 'btnAtivar', 'modalAtivarCliente', 'ativarCliente', 'listarCliente')" class="btn btn-outline-danger border-secondary-subtle" data-bs-toggle="modal" data-bs-target="#modalAtivarCliente">Ativado</button>
